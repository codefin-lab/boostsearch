...
static A_8: &'static [Among<Context>; 3] =
    &[Among("kk", -1, 1, None), Among("pp", -1, 2, None), Among("tt", -1, 3, None)];

static A_9: &'static [Among<Context>; 3] =
    &[Among("ma", -1, 2, None), Among("mai", -1, 1, None), Among("m", -1, 1, None)];
    ...
    'lab8: loop {
        'lab9: loop {
            ...
            'lab22: loop {
                ...
                let v_25 = env.limit_backward;
                env.limit_backward = i_p1;
                env.ket = env.cursor;
                if !env.eq_s_b(&"i") {
                    env.limit_backward = v_25;
                    break 'lab22;
                }
                env.bra = env.cursor;
                env.limit_backward = v_25;
