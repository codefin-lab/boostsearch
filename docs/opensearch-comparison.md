...
## ผล (ล่าสุด — หลัง block-stats sidecar)

query mix เพิ่ม time-filtered queries แล้ว (25% ของน้ำหนัก) ให้ใกล้ log workload จริง
วัดฝั่งละ 5 รอบในเซสชันเดียวกัน มัธยฐาน `[min-max]`

| | obsearch | OpenSearch 3.1.0 | |
|---|---:|---:|---|
| **memory (MB)** | **265** `[159-391]` | 1,533 `[1471-1600]` | obsearch **5.8 เท่า** |
| index docs/s | **78,040** `[75.0k-78.8k]` | 73,077 `[66.9k-73.9k]` | obsearch +7% |
| qps c=1 | **562** `[527-640]` | 430 `[420-519]` | obsearch **+30%** |
| p50 c=1 | **1.57 ms** `[1.43-1.73]` | 2.18 ms `[1.83-2.25]` | obsearch **−28%** |
| p99 c=1 | **3.01 ms** `[2.49-3.56]` | 4.06 ms `[3.08-4.95]` | obsearch **−26%** |
| qps c=8 | **1,782** `[1640-1864]` | 1,675 `[1570-1737]` | obsearch +6% |
| p50 c=8 | **4.20 ms** `[4.03-4.65]` | 4.49 ms `[4.27-4.70]` | obsearch −6% |
| p99 c=8 | **6.93 ms** `[6.19-7.36]` | 7.52 ms `[6.81-12.47]` | obsearch −8% |
| time_range p50 | **1.45 ms** | 2.07 ms | obsearch **−30%** |
| time_range_agg p50 | **1.73 ms** | 1.88 ms | obsearch −8% |
