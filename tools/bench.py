...
Engine-agnostic on purpose -- the same run drives velosearch or a real OpenSearch
...
def main():
    ...
    ap.add_argument("--proc", default="velosearch", help="process name to sample RSS for")
    ap.add_argument("--label", default="velosearch")
